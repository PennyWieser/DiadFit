...
latex_documents = [
    (master_doc, 'DiadFit.tex', 'DiadFit Documentation',
     'Penny Wieser', 'manual'),
]
...
man_pages = [
    (master_doc, 'DiadFit', 'DiadFit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DiadFit', 'DiadFit Documentation',
     author, 'DiadFit', 'One line description of project.',
     'Miscellaneous'),
]
